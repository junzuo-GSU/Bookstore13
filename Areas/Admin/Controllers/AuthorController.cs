...
namespace Bookstore.Areas.Admin.Controllers
{
    ...
    public class AuthorController : Controller
    {
        ...
        public RedirectToActionResult Select(int id, string operation)
        {
            ...
            {
                case "edit": //hard-coded literal is discouraged
        ...
        public IActionResult Add(Author author, string operation)
        {
            ...
            if (!validate.IsAuthorChecked) { //if client-end has not validate the author
            ...
            if (ModelState.IsValid) {
                data.Insert(author);
                data.Save();
                validate.ClearAuthor();//clean the TempData so it does not interfere with next author operation
        ...
        // delete: do not allow deleting author if author's book still exist
        [HttpGet]
