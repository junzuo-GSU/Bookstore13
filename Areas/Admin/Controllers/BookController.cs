...
namespace Bookstore.Areas.Admin.Controllers
{
    ...
    public class BookController : Controller
    {
        ...
        //book handling is more complicated because its association with author and genre
        ...
        public IActionResult Edit(BookViewModel vm)
        {
            if (ModelState.IsValid) {
                ...
                // because retrieved book with authors from DB at beginning of Edit()  - connected scenario
                bookData.Save(); 
        ...
        public ViewResult Related(string id)
        {
            ...
            return View(bookData.List(options)); //redirect to list the books related to author or genre
        }
        ...
        //load all available authors and genres from database
